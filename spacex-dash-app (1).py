...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                step=2500, marks={0: '0', 2500: '2500', 5000: '5000', 7500: '7500', 10000: '10000'},
...
def pie_chart(launch_site):
    ...
    if launch_site == 'ALL':
        ...
        names='Launch Site',
        title='Total Success Launch Rates')
        return fig
    else:
        fig = px.pie(filtered_df, names='class', title="Total Success Launch Rates")
        return fig
...
def scatter_chart(launch_site, payload_mass):
    filtered_df = spacex_df[spacex_df["Launch Site"] == launch_site]
    if launch_site == 'ALL':
